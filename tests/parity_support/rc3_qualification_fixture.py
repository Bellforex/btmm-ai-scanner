...
* ``m15``: 120 M15 bars ending 2026-09-17 06:30 UTC. The author marked the BUY
  FVG sourced 05:15 (4294.06-4295.89) weak and the BUY FVG sourced 05:30
  (4298.06-4304.27) valid.
* ``h1``: 120 H1 bars ending 2026-09-17 08:00 UTC. The BUY FVG sourced 04:00
...
def main() -> int:  # pragma: no cover - manual rebuild
    ...
    for stem, tf, end in (
        ...
        ("h1", Timeframe.H1, "2026-09-17T08:00"),
    ):
        ...
        doc[stem] = [
            ...
            for c in candles[last - 119 : last + 1]
        ]

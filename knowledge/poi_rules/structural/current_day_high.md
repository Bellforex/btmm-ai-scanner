...
The task brief's "Current Day High" corresponds to the book's own term "High of the Day" (paragraph 643) - same concept, different word order/label. Recorded as a naming difference, not a separate POI.
...
The highest price reached during the current trading day; an intraday level watched for breakout, reversal, or liquidity-sweep opportunities.
...
The exact high price of the calendar window (a level, not a zone - upper and lower boundary collapse to the same single price).

## Lower boundary

Not applicable (see Upper boundary).

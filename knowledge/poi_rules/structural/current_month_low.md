...
Corresponds to the book's "Low of the Month" (paragraph 653) - naming difference, not a separate POI.
...
The lowest price reached during the current month; a major higher-timeframe POI.
